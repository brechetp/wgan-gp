#!/usr/bin/env python3
##########################################################
# Copyright (c) Institute of Bioinformatics, Johannes Kepler University Linz
##########################################################
            ...
            if shape._dims != []:
              ...
              for j, s in enumerate(shape):
                if s == 1 and j == 0:
                  ...
                  new_shape.append(s)
              o._shape = tf.TensorShape(new_shape)#o.__dict__['_shape_val'] = tf.TensorShape(new_shape)
    return pool3
#-------------------------------------------------------------------------------
